...
4. Evolution of Cloud Hosting
5. The shared responsibility model
6. Cloud deployment models - public, private, and hybrid
7. Cloud service models - Infrastructure as a Service (IaaS), Platform as a Service (PaaS), Software as a Service (SaaS)
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# I. Introduction 
...
# II. What is Cloud computing ?
 ...
 - Essential characteristics of cloud model:
    ...
    d. Security - physical security (security with biometric scanners, multi-level authentication and more), data security (protected with advanced encryption technologies)
    ...
    g. Flexibile & Easy to access - on-demand self-service management through a web browser or a command-line interface
    ...
    k. Agility - React, innovate & adapt to changing needs of the market 
...
## Key aspects of On premise (Traditional IT System)
 ...
 -  Hire IT admins, staff, training : build, secure, operate and manage infrastructure
 -  Buy/lease Real estate
 ...
 -  Take all risk in Data Center Management
...
## (CSP) Cloud Service Provider / Cloud Providers  @ Cloud Industry
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
## IV. Evolution of Cloud Hosting
1. Dedicated Server
    a. One physical machine dedicated to a single business (single web app)
    b. Single tenant - Expensive & high maintenance but very secure
2. Virtual Private Server (VPS)
    a. Same as dedicated server but virtualized to run multiple apps
...
3. Shared hosting
    ...
    b. Economical but limited functionality & poor isolation
4. Cloud hosting
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# V. The shared responsibility model
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# VI. Cloud deployment/delivery models
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# VII. Cloud Computing Service models
