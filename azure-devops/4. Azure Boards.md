...
# Basic Process
 ...
 - Only three work item types/concepts/artifacts:
    a. Epic
    b. Issue 
    c. Task
...
1. Create an Organization                : DemoProcesses
2. Create a Project in this organization : DemoBasic
Project name: Demo Basic -> Visibility: Private (Default) -> Version control: Git (Default) -> Work item process: Basic (Default) -> Create
