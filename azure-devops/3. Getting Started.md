...
4. What are Teams ?
5. Walkthrough of the key features of the Project Dashboard
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
# IV. What are Teams ?
 ...
 - On creation of a Project, automatically a team will be created with the same name
![Teams in Project](../assets/projects-and-teams.png)
![Default team for a Project](../assets/default-team-project.png)
 - 

-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# V. Walkthrough of the key features of the Project Dashboard
