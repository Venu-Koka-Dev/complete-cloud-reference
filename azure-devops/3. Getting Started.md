...
Project Name: ProjectSbtWebApp -> Visibility: Private -> Create Project -> Dashboard with all the possible actions we can perform in the project -> This is the starting point for everything we do
