...
7. What are Routing tables ?
8. Listing AWS services that are either hosted or associated with VPC
9. Create a basic VPC 
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
## How many VPCs do we typically need ?
 ...
 - For example, for VPC:
    a. Soft limit is 5 VPCs per AWS Account, per region i.e with 20 regions available at AWS, a single AWS account can create 100 VPCs, 5 per region
    b. Hard limit is 1000
   
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# IV. The default VPC 
 - The default VPC is available within each AWS region
...
## How are Routing tables populated/configured ?
 - They are populated with three types of routes:
    a. Directly connected routes - automtically populated 
...
![Every router has a Routing table](../assets/routing-tables-three.png)
1. Network 1
    - Has the IP Address group of: 192.168.0.0
    - Has an interface of: Eth0 (configured with 192.168.0.1)
2. Network 2
    - Has the IP Address group of: 10.0.0.0
    - Has an interface of: Eth1 (configured with 10.0.0.1)  
3. Network 3
    - Has the IP Address group of: 174.16.0.0
    - Has the interface
  
    - 
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# VIII. Listing AWS services that are either hosted or associated with VPC 
...
## What is CIDR block ?
 ...
 - The initial CIDR block that was added when you created the VPC can’t be changed; however, you have the option of adding additional secondary CIDR blocks to an existing VPC
